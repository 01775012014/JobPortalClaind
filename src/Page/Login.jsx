            ...
            <div className="w-full lg:w-[80%] lg:flex  lg:flex-row-reverse relative z-10">
                ...
                <div className="bg-white bg-opacity-80 lg:w-[40%] backdrop-blur-sm rounded-3xl shadow-xl p-8 border border-white border-opacity-20">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
